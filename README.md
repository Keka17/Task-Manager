...
* __Real-time обновление__: Использование __WebSocket__ для мгновенного изменения статуса задач без перегрузки страницы.
...
## Стек технологий
* Backend: _FastAPI, Uvicorn, Pydantic v2, WebSockets_
